...
export const SERVICES = [
  ...
  { slug: 'waterproofing', bg: 'linear-gradient(135deg,#072a2b,#0d4547,#0ea5a8)', icon: 'water', accent: '#0ea5a8', title: 'Waterproofing',
    ...
    detail: [
      'Seepage almost always starts as an exterior problem — a hairline crack, a terrace losing its waterproof layer, a gap around a window frame — that shows up as a damp patch somewhere else entirely, often a room or a floor away from the actual entry point. Water travels through the smallest opening and follows gravity, not a straight line, which is why guessing at the source from where the stain appears indoors is usually wrong.',
      'We inspect the likely entry points first — terrace surfaces, external wall cracks, window and door frame joints, and plumbing penetrations — before recommending any treatment. That typically means a proper waterproofing membrane or coating at the actual source, not just repainting the visible damp patch, which is why painting alone over a seepage-affected wall usually resurfaces within one monsoon cycle.',
      'Once the source is treated and fully dried, we repaint the affected area to match — so the fix is both structural and cosmetic, not one without the other.',
    ] },
